...
def main():
    ...
    parser.add_argument(
        "--use-dataset",
        action="store_true",
        help="Run evaluation on TruthfulQA validation set"
    )
    ...
    # Initialize analyzer — ExternalVerifier loads TruthfulQA from HuggingFace
    ...
    # ======================================
    # OPTION 1: Run on full TruthfulQA dataset
    # ======================================
    if args.use_dataset:
    ...
    # ======================================
    # OPTION 2: Run single prompt manually
    # ======================================
    elif args.prompt:
        results = analyzer.analyze(
            prompt=args.prompt,
